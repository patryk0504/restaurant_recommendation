...
import SelectColumnFilter from "./table_filters/TableSelectLocationColumnFilter";
            ...
            },
            {
                ...
                columns: [
                    ...
                    },
                    {
                        Header: 'Cuisines',
                        // accessor: 'cuisines',
                        accessor: (row) => row.cuisines.map((a) => a.name).join(" "),
                        hideable: true,
                        ...
                        Cell: table_props =>
                            <Col>
                                <ul>
                                    {
                                        table_props.cell.value.split(" ").map(cuisine => (
